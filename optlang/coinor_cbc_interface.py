...
class Variable(interface.Variable):
    def __init__(self, name, var_type=BINARY, index=None, *args, **kwargs):
        super(Variable, self).__init__(name, **kwargs)
        self.var_type = var_type

    # TOD0: implement _coinor_cbc_ methods
    ...
    def type(self, value):
        try:
            ...
            raise ValueError(
                "COIN-OR CBC cannot handle variables of type %s. The following variable types are available:\n" +
